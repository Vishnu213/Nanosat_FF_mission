...
def yaw_dynamics_casadi(t, yy, param, uu_out):
    ...
    y_dynamics[2] = 1/Izc * uu[0]  # Derivative of yaw rate (angular acceleration) for chief
...
def Dynamics_casadi(t, yy_in, param, uu):


    T = param["T"]
    S = param["S"]
    T_inv = param["T_inv"]
    # S_inv = ca.diag([1/S[0,0],1/S[1,1]])

    yy = ca.mtimes(T_inv, yy_in)
